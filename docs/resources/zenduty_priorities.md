...
* `team_id` - (Required, Forces new resource) The unique_id of team to create the priority in.
* `name` - (Required) The name of the priority.
* `color` - (Optional) The color of the priority. Validated by the API; the values used by the Zenduty UI are magenta, red, volcano, orange, gold, lime, green, cyan, blue, geekblue and purple.
